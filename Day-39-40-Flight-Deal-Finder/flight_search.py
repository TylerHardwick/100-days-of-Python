...
class FlightSearch:
    ...
    def find_flights(self, dest, city):
        ...
        try:
            ...
            find_new_flight_reply = requests.get(url=find_flights_endpoint, params=parameters, headers=headers)
            flight_details = find_new_flight_reply.json()["data"][0]
            flight_data = FlightData(
                ...
                link=flight_details["deep_link"],
                return_date=flight_details["route"][2]["local_departure"].split("T")[0],
                stop_overs=2,
